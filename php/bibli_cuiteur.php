 ...
 */
function wa_aff_infos(bool $connecte = true, mysqli $bd = null):void{
    echo '<aside>';
    if ($connecte){
        ...
        while ($t = mysqli_fetch_assoc($r)) {
            ...
            echo    
                '<li>', 
                    ...
                    echo
                    '<br>',
                    blablasTagAndMentionsLink($bd,wa_html_proteger_sortie($t['blTexte'])),
                    '<p class="finMessage">',
    ...
    if ($page == "") {
        ...
        echo
            ...
            '<table id=descriptionUtilisateur>',
                '<tr><td><label><STRONG>Date de naissance : </STRONG></label></td>', '<td><label>', wa_amj_clair($T['usDateNaissance']), '<br></label></td></tr>',
                '<tr><td><label><STRONG>Date d\'inscription : </STRONG></label></td>', '<td><label>' ,wa_amj_clair($T['usDateInscription']),'<br></label></td></tr>',
                '<tr><td><label><STRONG>Ville de résidence : </STRONG></label></td>', '<td><label>' ,$ville,'<br></label></td></tr>',
                
                '<tr><td><label id="bioUser"><STRONG>Mini-bio : </STRONG></label></td>', '<td><label>', $bio, '<br></label></td></tr>',
                '<tr><td><label><STRONG>Site Web : </STRONG></label></td>', '<td><label>', $web, '<br></label></td></tr>',
            '</table>';
        if($estabo==true){
            echo
