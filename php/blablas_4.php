...
// C'est ce qui est fait dans la fonction wa_est_entier()
if (count($_GET) != 1 || ! isset($_GET['id']) || ! wa_est_entier(($_GET['id'])) || $_GET['id'] <= 0){
...
if ($t['blTexte'] == null){
    echo '<li>', wa_html_proteger_sortie($t['autPseudo']), ' n\'a pas publié de message</li>';
}
else{
